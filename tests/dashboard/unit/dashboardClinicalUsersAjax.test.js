const GetUserInfoUseCase = require('../../../Back/src/application/usecase/dahsboard/getUserInfoUseCase');
...
describe('GetUserInfoUseCase', () => {
  ...
  test('Happy path', async () => {
    ...
    expect(dashboardRepository.fetchInfoUser).toHaveBeenCalledWith({ idUser: 7 });
  });
});